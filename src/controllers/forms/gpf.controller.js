...
exports.addGpf = async (req, res) => {
    ...
    exports.getGpf = async (req, res) => {
        console.log('helo from getGpf controller', req.query);
        try {
            let query = {};
            let data;
            let resultData = [];
                ...
                console.log('length ==> ', uniqueArray.length);
                        if(uniqueArray.length > 0 && uniqueArray[0].transferOrPostingEmployeesList){
                            ...
                            dataAll = {
                                ...
                                gpfType: data0.gpfType,
                                availedDate: data0.availedDate,
                                availedAmount: data0.availedAmount,
                                purpose: data0.purpose,
